...
/**
 * Директива‑биндинг для основной (primary) кнопки.
 *
 * Оборачивает стандартную кнопку в единый набор Tailwind‑стилей.
 */
@Component({
...
export class PrimaryButtonBinding {
  ...
  /**
   * Возвращает строку CSS‑классов для кнопки с учётом дополнительного класса.
   */
  get classes() : string {

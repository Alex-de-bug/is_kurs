...
public class GlobalExceptionHandlerFilter {
  ...
  public ResponseEntity<MessageDto> handleDataIntegrityViolation(
  ...
  public ResponseEntity<MessageDto> handleHttpMessageNotReadable(
      HttpMessageNotReadableException ex) {
    return new ResponseEntity<>(
        new MessageDto("Неверный формат данных для передачи на сервер"), HttpStatus.BAD_REQUEST);
  }
  ...
  public ResponseEntity<MessageDto> handleInvalidDataAccessApiUsage(
  ...
  public ResponseEntity<MessageDto> handleUsernameNotFoundException(UsernameNotFoundException ex) {
    return new ResponseEntity<>(
        new MessageDto("Неизветсный пользователь, войдите в систему заново"),

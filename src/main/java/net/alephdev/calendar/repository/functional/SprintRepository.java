...
public interface SprintRepository extends JpaRepository<Sprint, Integer> {
  ...
  List<SprintTeamProjection> getSprintsByYearAndTeam(
      @Param("year") Integer year, @Param("teamName") String teamName);
  ...
  Page<Sprint> findAllByMajorVersionContainingAndTeamId(
      String majorVersion, Integer teamId, PageRequest endDate);
